...
all_planets_data = [{"image_path": "Assets/Switch_Level/planet1.png", "x": 300},
    {"image_path": "Assets/Switch_Level/planet2.png", "x": 950},
    {"image_path": "Assets/Switch_Level/planet3.png", "x": 1600},{"image_path": "Assets/Switch_Level/planet4.png", "x": 2250}]
planets = []
planet_rects = []
...
while True:
    ...
    if menu:
        ...
        if not orbital_game_phase and not loaded_level:
            loaded_level, level_number = level_selection(screen, background_level_map, planets, planet_rects, arrows,arrow_rects)
        ...
        if loaded_level:
            ...
            if shooting_trajectory:
                shooting_trajectory, orbital_game_phase, loaded_level = trajectory_simulation.projectile_motion(circle_x, circle_y, g, v, h, alpha, level_number, level_attempts, clock)
            else:
